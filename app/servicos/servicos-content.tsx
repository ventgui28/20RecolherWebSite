...
export function ServicosContent() {
  return (
    <div className="bg-transparent selection:bg-emerald-500 selection:text-white grain-overlay pt-32">
        ...
        <div className="max-w-7xl mx-auto px-6 relative z-10">
          <div className="flex flex-col md:flex-row md:items-end justify-between mb-32 gap-12">
            <div className="max-w-3xl">
              ...
              >
                O QUE <br /><span className="text-emerald-600">RECOLHEMOS.</span>
              </motion.p>
            </div>
            <div className="hidden md:block pb-4">
              <p className="text-gray-400 font-medium text-right max-w-[240px] leading-relaxed italic">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <ScrollReveal className="group">
              <div className="h-full p-10 rounded-[3rem] bg-white border border-emerald-500/10 transition-all duration-700 group-hover:shadow-[0_40px_100px_-20px_rgba(16,185,129,0.1)] group-hover:border-emerald-300">
                ...
                <ul className="space-y-6">
                  {[
                    ...
                    <li key={item} className="flex items-center space-x-4 group/item">
                      <div className="w-1.5 h-1.5 rounded-full bg-emerald-500 transition-all duration-500 group-hover/item:scale-150 group-hover/item:shadow-[0_0_10px_#10B981]" />
                      <span className="text-[#012F24]/70 font-medium text-lg transition-colors group-hover/item:text-black">{item}</span>
                    </li>
                  ))}
                </ul>
              </div>
            ...
            <ScrollReveal delay={0.2} className="group">
              <div className="h-full p-10 rounded-[3rem] bg-[#012F24] border border-emerald-900/50 transition-all duration-700 shadow-2xl relative overflow-hidden">
                ...
                <ul className="space-y-6 relative z-10">
                  {[
                    ...
                    <li key={item} className="flex items-center space-x-4 group/item">
                      <div className="w-1.5 h-1.5 rounded-full bg-emerald-400 transition-all duration-500 group-hover/item:scale-150 group-hover/item:shadow-[0_0_10px_#34D399]" />
                      <span className="text-emerald-100/60 font-medium text-lg transition-colors group-hover/item:text-white">{item}</span>
                    </li>
                  ))}
                </ul>
                <div className="mt-20 pt-10 border-t border-white/10 relative z-10">
                  <p className="text-[10px] font-black text-emerald-400 uppercase tracking-[0.3em] mb-4">Certificação Total</p>
                  <p className="text-white/40 text-sm font-medium leading-relaxed">Garantimos a valorização de 100% dos metais recolhidos.</p>
                </div>
              </div>
            </ScrollReveal>
          </div>
        ...
        <div className="max-w-7xl mx-auto px-6">
          <div className="grid grid-cols-1 md:grid-cols-12 gap-8">
            ...
            <ScrollReveal className="md:col-span-8">
              <div className="bento-card-emerald h-full flex flex-col justify-between group">
                ...
                <div>
                  <h3 className="text-4xl md:text-6xl font-black mb-6 tracking-tighter uppercase leading-[0.9]">Recolha REEE&apos;s <br />e Metais</h3>
                  <p className="text-emerald-50/60 text-lg font-medium leading-relaxed mb-8 max-w-xl">
            ...
            <ScrollReveal className="md:col-span-4">
              <div className="bento-card h-full flex flex-col justify-between group border-emerald-100 bg-white">
                <div className="flex justify-between items-start mb-12">
                  ...
                  <span className="text-2xl font-black text-emerald-100">03</span>
                </div>
                <div>
                  <h3 className="text-3xl font-black text-black mb-4 tracking-tighter uppercase">Toners Vazios</h3>
                  <p className="text-[#012F24]/70 font-medium leading-relaxed">
            ...
            {/* 02. Componentes */}
            <ScrollReveal className="md:col-span-4">
              <div className="bento-card h-full flex flex-col justify-between group bg-white border-emerald-100">
                <div className="flex justify-between items-start mb-12">
                  <div className="w-16 h-16 bg-emerald-50/30 rounded-2xl flex items-center justify-center border border-emerald-100/20 shadow-sm">
                    <Zap className="h-8 w-8 text-emerald-600" />
                  </div>
                  <span className="text-2xl font-black text-emerald-50">02</span>
                </div>
                <div>
                  <h3 className="text-2xl font-black text-black mb-4 tracking-tighter uppercase leading-tight">Componentes <br />Informáticos</h3>
                  <p className="text-[#012F24]/70 font-medium leading-relaxed text-sm">
            ...
            <ScrollReveal className="md:col-span-8">
              <div className="bento-card h-full flex flex-col md:flex-row gap-12 group overflow-hidden relative">
                ...
                <div className="md:w-3/5 relative z-10 flex flex-col justify-between">
                  ...
                  <span className="text-5xl font-black text-black/5">05</span>
                </div>
                <div className="md:w-2/5 flex flex-col justify-center space-y-4 relative z-10">
                   {["Declaração de Abate", "Emissão E-Gar", "Conformidade Total"].map((text) => (
                     <div key={text} className="p-5 glass rounded-2xl border-emerald-100 shadow-xl flex items-center space-x-4">
            ...
            <ScrollReveal className="md:col-span-4">
              <div className="bento-card h-full flex flex-col justify-between group border-emerald-50">
                <div className="flex justify-between items-start mb-10">
                  <div className="w-14 h-14 bg-emerald-50 rounded-xl flex items-center justify-center">
                    <ShieldCheck className="h-6 w-6 text-emerald-600" />
                  </div>
                  <span className="text-2xl font-black text-black/5">04</span>
                </div>
                <h3 className="text-2xl font-black text-black mb-4 uppercase tracking-tighter">Toners Originais <br />Fora de Validade</h3>
                <p className="text-gray-500 text-sm font-medium">Recolha e valorização de consumíveis cheios originais.</p>
              </div>
            </ScrollReveal>
            ...
            <ScrollReveal className="md:col-span-4">
              <div className="bento-card h-full flex flex-col justify-between group border-emerald-50">
                <div className="flex justify-between items-start mb-10">
                  ...
                  <span className="text-2xl font-black text-black/5">06</span>
                </div>
                <h3 className="text-2xl font-black text-black mb-4 uppercase tracking-tighter">Consultadoria Ambiental</h3>
                <p className="text-gray-500 text-sm font-medium">Apoio no Siliamb, emissão de E-gar e suporte legal especializado.</p>
              </div>
            </ScrollReveal>

            {/* 07. Destruição de Dados */}
            <ScrollReveal className="md:col-span-4">
              <div className="bento-card h-full flex flex-col justify-between group bg-emerald-600 text-white border-none">
                <div className="flex justify-between items-start mb-10">
                  <div className="w-14 h-14 bg-white/10 rounded-xl flex items-center justify-center">
                    <ShieldCheck className="h-6 w-6 text-white" />
                  </div>
                  <span className="text-2xl font-black text-white/10">07</span>
                </div>
                <h3 className="text-2xl font-black mb-4 uppercase tracking-tighter">Destruição de Discos</h3>
                <p className="text-emerald-50/60 text-sm font-medium">Destruição certificada no cliente ou nas nossas instalações.</p>
              </div>
            </ScrollReveal>
        ...
        <div className="max-w-7xl mx-auto px-6 relative z-10">
          <div className="flex flex-col mb-40 text-center items-center">
            <motion.h2 
              ...
              whileInView={{ opacity: 1, y: 0 }}
              className="text-emerald-600 text-[10px] font-black uppercase tracking-[0.5em] mb-10"
            >
              A Nossa Operação
            </motion.h2>
            <motion.p 
            ...
            >
              MÉTODO DE <br /><span className="text-emerald-600">ALTA PRECISÃO.</span>
            </motion.p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-4 relative">
            {[
              ...
              >
                <div className="p-10 rounded-[2.5rem] bg-white border border-emerald-50 transition-all duration-700 hover:border-emerald-500 hover:shadow-[0_40px_100px_-20px_rgba(16,185,129,0.1)] h-full">
                  <div className="flex flex-col">
                    <div className="flex justify-between items-start mb-16">
                      <div className="w-16 h-16 rounded-2xl bg-emerald-50 flex items-center justify-center group-hover:bg-emerald-500 transition-all duration-700">
                        <step.icon className="w-7 h-7 text-emerald-600 group-hover:text-white transition-colors duration-700" />
                      </div>
                      <span className="text-5xl font-black text-emerald-100/50 group-hover:text-emerald-600/20 transition-colors">
                        {step.id}
                      </span>
                    </div>
                    ...
                    <p className="text-[#012F24]/60 font-medium text-sm leading-relaxed tracking-tight">
                      {step.text}
                    </p>
                  </div>
                </div>
