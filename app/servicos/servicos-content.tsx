        ...
        <div className="max-w-7xl mx-auto px-6 relative z-10">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <ScrollReveal className="group">
              <div className="h-full p-10 rounded-[3rem] bg-white border border-green-500/10 transition-all duration-700 group-hover:shadow-[0_40px_100px_-20px_rgba(16,185,129,0.1)] group-hover:border-green-300">
                ...
                <ul className="space-y-6">
                  {[
                    ...
                    <li key={item} className="flex items-center space-x-4 group/item">
                      ...
                      <span className="text-[#0a2d10]/70 font-medium text-lg transition-colors group-hover/item:text-black">{item}</span>
                    </li>
                  ))}
                </ul>
              </div>
            ...
            <ScrollReveal delay={0.2} className="group">
              <div className="h-full p-10 rounded-[3rem] bg-[#0a2d10] border border-green-900/50 transition-all duration-700 shadow-2xl relative overflow-hidden">
                ...
                <ul className="space-y-6 relative z-10">
                  {[
                    ...
                    <li key={item} className="flex items-center space-x-4 group/item">
                      ...
                      <span className="text-green-100/60 font-medium text-lg transition-colors group-hover/item:text-white">{item}</span>
                    </li>
                  ))}
                </ul>
        ...
        <div className="max-w-7xl mx-auto px-6">
          <div className="grid grid-cols-1 md:grid-cols-12 gap-8">
            ...
            <ScrollReveal className="md:col-span-8">
              <div className="bento-card-ocean h-full flex flex-col justify-between group">
                ...
                <div>
                  ...
                  <p className="text-green-50/60 text-lg font-medium leading-relaxed mb-8 max-w-xl">
            ...
            <ScrollReveal className="md:col-span-4">
              <div className="bento-card h-full flex flex-col justify-between group border-green-100 bg-white">
                <div className="flex justify-between items-start mb-12">
                  ...
                  <span className="text-2xl font-black text-green-100">03</span>
                </div>
                <div>
                  <h3 className="text-3xl font-black text-black mb-4 tracking-tighter uppercase">Toners Vazios</h3>
                  <p className="text-[#0a2d10]/70 font-medium leading-relaxed">
            ...
            {/* 02. Componentes */}
            <ScrollReveal className="md:col-span-4">
              <div className="bento-card h-full flex flex-col justify-between group bg-white border-green-100">
                <div className="flex justify-between items-start mb-12">
              ...
              <div className="bento-card h-full flex flex-col md:flex-row gap-12 group overflow-hidden relative">
                ...
                <div className="md:w-2/5 flex flex-col justify-center space-y-4 relative z-10">
                   {["Declaração de Abate", "Emissão E-Gar", "Conformidade Total"].map((text) => (
                     <div key={text} className="p-5 glass rounded-2xl border-green-100 shadow-xl flex items-center space-x-4">
            ...
            <ScrollReveal className="md:col-span-4">
              <div className="bento-card h-full flex flex-col justify-between group border-green-50">
            ...
            <ScrollReveal className="md:col-span-4">
              <div className="bento-card h-full flex flex-col justify-between group bg-green-600 text-white border-none">
                <div className="flex justify-between items-start mb-10">
                ...
                <p className="text-green-50/60 text-sm font-medium">Destruição certificada no cliente ou nas nossas instalações.</p>
              </div>
            </ScrollReveal>
        ...
        <div className="max-w-7xl mx-auto px-6 relative z-10">
          <div className="flex flex-col mb-40 text-center items-center">
            <motion.h2 
              ...
              whileInView={{ opacity: 1, y: 0 }}
              className="text-green-600 text-[10px] font-black uppercase tracking-[0.5em] mb-10"
            >
              A Nossa Operação
            </motion.h2>
            <motion.p 
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-4 relative">
            {[
              ...
              >
                <div className="p-10 rounded-[2.5rem] bg-white border border-green-50 transition-all duration-700 hover:border-green-500 hover:shadow-[0_40px_100px_-20px_rgba(16,185,129,0.1)] h-full">
                  <div className="flex flex-col">
                    <div className="flex justify-between items-start mb-16">
                      ...
                      <span className="text-5xl font-black text-green-100/50 group-hover:text-green-600/20 transition-colors">
                        {step.id}
                      </span>
                    </div>
                    ...
                    <p className="text-[#0a2d10]/60 font-medium text-sm leading-relaxed tracking-tight">
                      {step.text}
                    </p>
                  </div>
                </div>
