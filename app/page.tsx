          ...
          <div className="lg:flex lg:items-center lg:gap-40">
            ...
            <ScrollReveal direction="right" className="lg:w-1/2 mb-32 lg:mb-0">
              <div className="flex items-center space-x-4 mb-10">
                ...
                <span className="text-green-600 text-[10px] font-black uppercase tracking-[0.5em]">Padrões Globais</span>
              </div>
              
              <h3 className="text-5xl md:text-8xl font-black text-[#0a2d10] mb-16 tracking-[-0.06em] leading-[0.85] uppercase">
                ZERO <br /><span className="text-green-600">COMPROMISSO</span>
              </h3>
              ...
              <div className="grid grid-cols-1 gap-12 mb-20">
                {[
                  ...
                  <ScrollReveal key={idx} delay={idx * 0.1} className="flex items-start space-x-8 group">
                    <div className="bg-white p-5 rounded-[2rem] border border-green-100 shadow-sm group-hover:border-green-300 transition-all duration-500 group-hover:shadow-lg group-hover:shadow-green-500/10">
                      <item.icon className="h-6 w-6 text-green-600" />
                    </div>
                    <div>
                      <h4 className="text-[#0a2d10] font-black text-xs tracking-[0.2em] uppercase mb-3">{item.title}</h4>
              ...
              <Link
                href="/sobre"
                className="inline-flex items-center font-black text-[#0a2d10] hover:text-green-600 transition-all group tracking-tighter text-sm uppercase"
              >
            ...
            <ScrollReveal direction="left" className="lg:w-1/2">
              <div className="relative">
                <div className="bento-card-green h-[600px] flex items-center justify-center relative overflow-hidden group shadow-2xl shadow-green-900/40">
                   <div className="absolute inset-0 bg-[radial-gradient(circle_at_center,_var(--tw-gradient-stops))] from-green-400/20 via-transparent to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-1000" />
                   
                   <div className="text-center relative z-10 px-12">
                      <motion.div 
                        animate={{ y: [0, -20, 0], rotate: [0, 5, 0] }}
                        transition={{ duration: 6, repeat: Infinity, ease: "easeInOut" }}
                        className="w-32 h-32 bg-green-400/10 rounded-[3rem] flex items-center justify-center mx-auto mb-12 border border-green-400/20 backdrop-blur-xl"
                      >
                        <Recycle className="h-12 w-12 text-green-300" />
                      </motion.div>
                      ...
                      <div className="flex justify-center space-x-2">
                        {[1,2,3].map(i => (
                          <div key={i} className="w-1.5 h-1.5 rounded-full bg-green-400/40" />
                        ))}
                      </div>
                   </div>
                ...
                <motion.div 
                  ...
                  className="absolute -bottom-10 -left-10 glass p-8 rounded-[2.5rem] shadow-2xl border border-green-100/50 hidden md:block"
                >
                   <div className="flex items-center space-x-6">
                      <div className="w-12 h-12 rounded-full bg-green-600 flex items-center justify-center shadow-lg shadow-green-500/20">
      ...
      <section className="py-60 bg-transparent relative overflow-hidden">
        ...
        <div className="max-w-5xl mx-auto px-6 text-center relative z-10">
          <ScrollReveal>
            ...
            <h2 className="text-5xl md:text-8xl font-black text-[#0a2d10] mb-12 tracking-[-0.07em] leading-[0.85] uppercase">
            ...
            <div className="flex flex-col sm:flex-row justify-center items-center space-y-6 sm:space-y-0 sm:space-x-10">
              ...
              <Link
                href="/contactos"
                className="text-[12px] font-black uppercase tracking-[0.3em] text-[#0a2d10] hover:text-green-600 transition-colors border-b-2 border-green-100 hover:border-green-600 pb-2"
              >
                Falar com Consultor
              </Link>
            </div>
