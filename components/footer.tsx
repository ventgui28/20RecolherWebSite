...
export function Footer() {
  ...
  return (
    <footer className="bg-black text-gray-500 py-32 border-t border-white/[0.03] mt-auto relative overflow-hidden">
      ...
      <div className="absolute bottom-0 right-0 w-[500px] h-[500px] bg-green-500/5 blur-[120px] rounded-full -z-10" />
      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-12 relative z-10">
        <div className="grid grid-cols-1 md:grid-cols-12 gap-20">
          ...
          <div className="md:col-span-5">
            <Link href="/" className="flex items-center space-x-3 mb-10 group">
              <div className="bg-green-600 p-2.5 rounded-xl transition-transform duration-500 group-hover:rotate-[15deg]">
            ...
            <div className="flex space-x-8">
               <div className="w-px h-12 bg-green-600/30" />
          ...
          <div className="md:col-span-2">
            ...
            <ul className="space-y-6 text-[12px] font-bold uppercase tracking-widest">
              <li><Link href="/sobre" className="hover:text-green-400 transition-colors">Legado</Link></li>
              <li><Link href="/servicos" className="hover:text-green-400 transition-colors">Portfólio</Link></li>
              <li><Link href="/clientes" className="hover:text-green-400 transition-colors">Setores</Link></li>
              <li><Link href="/sustentabilidade" className="hover:text-green-400 transition-colors">Manifesto</Link></li>
              <li><Link href="/contactos" className="hover:text-green-400 transition-colors">Canais</Link></li>
            </ul>
          </div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-12">
               <div className="space-y-8">
                  <div className="flex flex-col space-y-2">
                     <span className="text-[9px] font-black text-green-500 uppercase tracking-widest">Localização Central</span>
                  ...
                  <div className="flex flex-col space-y-2">
                     <span className="text-[9px] font-black text-green-500 uppercase tracking-widest">Linha de Apoio</span>
                     <span className="text-lg font-black text-white">+351 912 858 819</span>
                  </div>
               </div>
               <div className="space-y-8">
                  <div className="flex flex-col space-y-2">
                     <span className="text-[9px] font-black text-green-500 uppercase tracking-widest">Comunicação Oficial</span>
        ...
        <div className="border-t border-white/5 mt-32 pt-16 flex flex-col md:flex-row items-center justify-between">
          ...
          <div className="flex space-x-12 text-[10px] font-bold uppercase tracking-[0.2em]">
            <Link href="/privacidade" className="text-white/20 hover:text-green-400 transition-colors">Privacidade</Link>
            <Link href="/termos" className="text-white/20 hover:text-green-400 transition-colors">Termos de Serviço</Link>
            <div className="flex items-center text-white/10">
               <span className="w-1 h-1 rounded-full bg-green-500 mr-2" />
               Portugal / EU
            </div>
          </div>
        </div>
