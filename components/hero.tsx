...
export function Hero() {
  return (
    <section className="relative min-h-screen flex items-center justify-center pt-20 overflow-hidden bg-white bg-grid-technical">
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6 text-center">
        ...
        <motion.div
          ...
          className="inline-flex items-center space-x-2 px-4 py-1.5 rounded-full bg-emerald-50/50 border border-emerald-100/50 text-emerald-700 text-[11px] font-bold uppercase tracking-[0.2em] mb-10 backdrop-blur-md"
        >
        ...
        <motion.h1
          ...
          className="h1-hero text-elite mb-12"
        >
